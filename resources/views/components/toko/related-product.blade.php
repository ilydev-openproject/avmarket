                        ...
                        <div class="swiper-slide">
                            <div class="tpproduct p-relative">
                                <div class="tpproduct__thumb p-relative text-center">
                                    <a href="/produk/{{ $related->slug }}"><img
                                            src="{{ $related->getMedia('foto_product')->first()?->getUrl() }}" alt=""
                                            style="aspect-ratio: 1/1; object-fit: cover; width: 100%;"></a>
                                    <a class="tpproduct__thumb-img" href="/produk/{{ $related->slug }}"><img
                                            src="{{ $related->getMedia('foto_product')->get(1)?->getUrl() }}" alt=""
                                            style="aspect-ratio: 1/1; object-fit: cover; width: 100%;"></a>
                                    <div class="tpproduct__info bage">
                                        <span class="tpproduct__info-discount bage__discount">{{$related->diskon}}%</span>
                                        <span
                                            class="tpproduct__info-hot bage__hot">{{ $related->label == 1 ? 'SUPER MURAH🔥' : 'MURAH' }}</span>
                                    </div>
                                ...
                                <div class="tpproduct__content">
                                    ...
                                    <h4 class="tpproduct__title">
                                        <a href="/produk/{{ $related->slug }}">{{ $related->nama_product}}</a>
                                    </h4>
