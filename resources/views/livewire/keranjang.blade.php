            ...
            <div class="row d-flex justify-content-between align-items-stretch">
                        ...
                        <div class="h-100 d-flex flex-column justify-content-between align-items-between me-5">
                            <div class="d-flex flex-column">
                                <div class="product-name text mb-3 cust-prod">
                                    <a href="shop-details.html" class="d-block text-truncate" style="max-width: 100%;">{{ $item['nama'] }}</a>
                                </div>
                                <td class="product-price">
                                    <span class="amount">Rp{{ number_format($item['harga'], 0, ',', '.') }} | <text class="text-success">Stok Aman</text></span>
                                </td>
                            </div>
                            <div>
                                <td class="product-quantity">
                                    <div class="qty-btn d-flex justify-content-center align-items-center m-0">
                                        <span class="cart-minus cust-minus m-0" wire:click="decreaseQuantity({{ $id }})">-</span>
                                        <input class="cart-input cust-qty m-0" type="text" value="{{ $item['quantity'] }}" readonly>
                                        <span class="cart-plus cust-plus m-0" wire:click="increaseQuantity({{ $id }})">+</span>
                                    </div>
                                </td>
                            </div>
                        </div>
                ...
                <div class="col-4 py-lg-5 py-2">
                    <div class="h-100 d-flex flex-column justify-content-between align-items-end py-lg-5 py-2">
                        ...
                        <a href="#" wire:click.prevent="removeFromCart({{ $id }})" class="btn btn-outline-danger px-4 mt-5">
                            ...
                            <div class="col-12">
                                <div class="coupon-all">
                                    <div class="coupon">
                                        ...
                                        <button class="tp-btn tp-color-btn banner-animation" name="apply_coupon" type="submit">
                                            Apply Coupon
                                        </button>
                                    </div>
                                    <!-- <div class="coupon2">
