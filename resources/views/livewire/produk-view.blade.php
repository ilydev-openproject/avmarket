                ...
                <div class="col">
                    <div class="tpproduct p-relative mb-20">
                        <div class="tpproduct__thumb p-relative text-center">
                            <a href="#"><img src="{{ $product->getMedia('foto_product')->get(1)?->getUrl() }}" alt="{{$product->nama_product}}"></a>
                            <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="{{ $product->getMedia('foto_product')->first()?->getUrl() }}" alt="{{$product->nama_product}}"></a>
