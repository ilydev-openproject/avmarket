                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="checkout-form-list">
                            ...
                            <input type="text" wire:model="district" placeholder="Kecamatan">
            ...
            <div class="your-order mb-30 ">
                ...
                <div class="payment-method">
                            ...
                            <div id="bankOne" class="accordion-collapse collapse show" aria-labelledby="checkoutOne" data-bs-parent="#checkoutAccordion">
                                <div class="accordion-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card h-100 border-0 shadow-sm {{ $selectedPaymentMethod == 'bni' ? 'border-primary border-2' : '' }}"
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    <img src="{{ asset('/image/bank/bni.jpg') }}" alt="BNI" class="img-fluid mb-3" style="max-height: 50px;">
                                            ...
                                            <div class="card h-100 border-0 shadow-sm {{ $selectedPaymentMethod == 'bca' ? 'border-primary border-2' : '' }}"
                                                ...
                                                <div class="card-body text-center">
                                                    <input type="radio"
                                                        ...
                                                        value="bca"
                                                        wire:model="selectedPaymentMethod">
                                                    <img src="{{ asset('/image/bank/bca.jpg') }}" alt="BCA" class="img-fluid mb-3" style="max-height: 50px;">
                                            ...
                                            <div class="card h-100 border-0 shadow-sm {{ $selectedPaymentMethod == 'cod' ? 'border-primary border-2' : '' }}"
                                                ...
                                                <div class="card-body text-center">
                                                    <input type="radio"
                                                        ...
                                                        value="cod"
                                                        wire:model="selectedPaymentMethod">
                                                    <img src="{{ asset('/image/bank/cod.jpg') }}" alt="COD" class="img-fluid mb-3" style="max-height: 80px;">
                                        ...
                                        <span>pembayaran di pilih: {{$selectedPaymentMethod}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="order-button-payment mt-20">
                        <button type="submit" class="tp-btn tp-color-btn w-100 banner-animation" wire:loading.attr="disabled">
